        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="#">
                         <img src="{{ asset ('frontend/assets/images/mbr-122x116.jpg') }}" alt="SP Pakar" title="" style="height: 3.8rem;">
                    </a>
                </span>
                <span class="navbar-caption-wrap"><a class="navbar-caption text-black display-7" href="#">
                        SISTEM PAKAR DIAGNOSA PENYAKIT ANJING</a></span>
            </div>
        </div>
...
<section class="cid-r80z4IeoU7" id="footer5-5">
    <div class="container">
        <div class="media-container-row">
            <div class="col-md-3">
                <div class="media-wrap">
                    <a href="#">
                       <img src="{{ asset ('frontend/assets/images/mbr-192x183.jpg') }}" alt="SP Pakar" title="">
                    </a>
                </div>
            </div>
            <div class="col-md-9">
            ...
            <div class="media-container-row mbr-white">
                <div class="col-md-6 copyright">
                    <p class="mbr-text mbr-fonts-style display-7">
                        © Copyright 2018 Stikom DB Jambi - All Rights Reserved
                    </p>
                </div>
                <div class="col-md-6">
  ...
  <script src="{{ asset ('frontend/assets/slick.min.js') }}"></script>
